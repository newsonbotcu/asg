...
class Kiz extends Command {
    ...
    async run(client, message, args) {
        ...
        await mentioned.roles.add(data.roles["Female"].concat(data.roles["member"]));
        ...
        await message.reply(new Discord.MessageEmbed().setDescription(`${mentioned} adlı kullanıcı başarıyla kayıt oldu.`).setColor("#ffb0e6"));
