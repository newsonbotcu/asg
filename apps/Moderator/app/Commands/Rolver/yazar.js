...
class Escritor extends Command {
    ...
    async run(client, message, args) {
        ...
        ${message.member} (\`${message.member.user.id}\`) adlı yetkili, ${mentioned} (\`${mentioned.user.id}\`) üyesin${durum === "Verildi" ? "e" : "den"} <@&${roles.get("role_yazar").value()}> rolü ${durum.toLowerCase()}.
